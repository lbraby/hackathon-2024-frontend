  ...
  return(
    <div className="w-full h-20 bg-[#FDF4E9] flex flex-row justify-between px-8 border-b-2 border-gray-300 sticky top-0">
      ...
      <div className="w-1/4 flex justify-end items-center"> 
        <p className='text-[#BB378E] font-bold'><Link to="/" className='bg-transparent rounded-md px-4 py-2 mx-2'>Profile</Link></p>
        <p><Link to="/" className='text-white bg-[#EC9D3F] font-bold rounded-md px-4 py-2 mx-2'>Log Out</Link></p>
      </div> 
    </div>
  );
};
